...
export function ApplicationListPage(props: ApplicationListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getApplications({
        ...
        order: params.order,
        searchTermKeys: ['status.contains', 'cover_letter.contains', 'resume_url.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'resume_url', header: 'Resume Url', accessorKey: 'resume_url' },
    ...
    hasAccess('freelancer_profile', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          cell: ({ row: { original: record } }: any) => (
            ...
            >
              {record.freelancer_profile?.skills}
            </Link>
          ),
        }
      : null,
