  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Upox 2 - Where freelancers find their perfect match. A marketplace designed to connect, collaborate, and succeed. Unleash your potential with us."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Upox 2 - Where freelancers find their perfect match. A marketplace designed to connect, collaborate, and succeed. Unleash your potential with us.`}
            </Text>
            <Box
